...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("29.02.8260000", dateStrToDigit("29 февраля 8260000"))
        assertEquals("", dateStrToDigit("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaa"))
    }

    @Test
    @Tag("4")
    fun dateDigitToStr() {
        assertEquals("1 декабря 1", dateDigitToStr("01.12.1"))
        ...
        assertEquals("", dateStrToDigit("01.13.01"))
    }
    ...
    fun bestHighJump() {
        ...
        assertEquals(-1, bestHighJump("220 + 224 %2+ 228 %- 230 + 232 %%- 234 %"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("Any good with price 0.01", mostExpensive("a 0.01; d 0.01"))
        assertEquals("Any good with price 0.0", mostExpensive("a 0"))
    }
